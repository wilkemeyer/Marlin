...
#define USE_CONTROLLER_FAN
  ...
  //#define CONTROLLER_FAN_PIN PB2           // Set a custom pin for the controller fan
  ...
  // Use TEMP_SENSOR_BED as a trigger for enabling the controller fan - to prevent warping the bottom deck
  #define CONTROLLER_FAN_MIN_BED_TEMP 40  // (°C) Turn on the fan if the bed reaches this temperature
...
#define FAN_KICKSTART_TIME 1400
...
#define EXTRUDER_AUTO_FAN_SPEED 170   // 170 = 66%,  255 == full speed
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  // 
  //  Z1   Z4
  #define Z_STEPPER_ALIGN_XY { { 50, 30 }, { 45, 290 }, { 320, 290 }, { 320, 30 } }
