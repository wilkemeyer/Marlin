...
#define STRING_CONFIG_H_AUTHOR "(voron24,fwi)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_FYSETC_SPIDER_VORON24_FWI
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "Voron2.4"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // PID Settings for Dragon - Standard Flow - 50w Heater, 250c
    #define DEFAULT_Kp  12.49
    #define DEFAULT_Ki   0.64
    #define DEFAULT_Kd  60.68
  #endif
#endif // PIDTEMP
 ...
 */
#define MAX_BED_POWER 130 // 50%!  limits duty cycle to bed; 255=full current
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 400, 1659.999999891062 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 40, 100 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 800, 10000 }
 ...
 */
//#define Z_MIN_PROBE_PIN PA3 // Z-MAX @ Spider
...
#define XY_PROBE_FEEDRATE (1250*60)
